...
#
# Original file: run_isaacsim.launch.py
...
# 
# Modified by: [Tharit Sinsunthorn/Spacedata Inc.] for [int-ball2_isaac_sim]
# Date: [July 2025]
...
def launch_setup(context):
    ...
    isaacsim_node = Node(
        package='ib2_isaac_sim', executable='run_isaacsim.py',
        name='ib2_isaac_sim', output="screen", 
        parameters=[{
